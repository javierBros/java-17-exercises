...
public class RepeatAndMissingNumberArray {
    ...
    public static void main(String[] args) {
        System.out.println();
        System.out.println(repeatedNumber(Arrays.asList(1,3,4,4,2,6)));
    ...
    public static ArrayList<Integer> repeatedNumber(final List<Integer> A) {
        Collections.sort(A);
        ArrayList<Integer> aAndBValues = new ArrayList<Integer>();
        int counter = 1;
        for(int i = 0; i < A.size(); i++){
            Integer value = A.get(i);
            if(counter>value){
                aAndBValues.add(value);
                break;
        ...
        for(int i = 0; i < A.size(); i++){
            Integer value = A.get(i);
            if(counter<value || counter==A.size()){
                aAndBValues.add(counter);
                break;
            } else if (counter++>value) {
                counter--;
            }
